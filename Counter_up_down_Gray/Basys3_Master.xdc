...
## Switches
set_property PACKAGE_PIN V17 [get_ports {select_mode}]					
set_property IOSTANDARD LVCMOS33 [get_ports {select_mode}]
set_property PACKAGE_PIN V16 [get_ports {ud_in}]					
set_property IOSTANDARD LVCMOS33 [get_ports {ud_in}]
...
#set_property PACKAGE_PIN L1 [get_ports {led[15]}]					
 ...
 #segment display
#set_property PACKAGE_PIN W7 [get_ports {out_div}]					
...
set_property PACKAGE_PIN W19 [get_ports buton_in]						
set_property IOSTANDARD LVCMOS33 [get_ports buton_in]
set_property PACKAGE_PIN T17 [get_ports reset_in]						
set_property IOSTANDARD LVCMOS33 [get_ports reset_in]
#set_property PACKAGE_PIN U17 [get_ports select_mode]						
#set_property IOSTANDARD LVCMOS33 [get_ports select_mode]
